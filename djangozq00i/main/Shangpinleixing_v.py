...
def shangpinleixing_page(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        msg['data']['pageSize']  =shangpinleixing.page(shangpinleixing, shangpinleixing, req_dict, request)
...
def shangpinleixing_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/djangozq00i/shangpinleixing/notify',
            #notify_url=''
        )
...
def shangpinleixing_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/djangozq00i/admin/dist/index.html#/shangpinleixing')
