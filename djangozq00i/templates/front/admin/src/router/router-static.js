...
import center from '@/views/center'
    ...
    import discussqicheshangpin from '@/views/modules/discussqicheshangpin/list'
    import discussqichexinxi from '@/views/modules/discussqichexinxi/list'
    import qichezulin from '@/views/modules/qichezulin/list'
    import qicheshangpin from '@/views/modules/qicheshangpin/list'
...
const routes = [{
	...
	path: '/qicheguihai',
      ...
      ,{
	path: '/discussqicheshangpin',
        name: '汽车商品评论',
        component: discussqicheshangpin
      }
      ,{
